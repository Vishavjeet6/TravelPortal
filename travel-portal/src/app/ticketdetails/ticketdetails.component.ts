...
export class TicketdetailsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this._sharedService.currentMessage.subscribe(message => this.userId = message);
    ...
    this.expenseBourneBy = this.ticket.expenseBourneBy;
    this.updateDate = this.formatDate(this.ticket.updatedAt);
  ...
  updateTicket(){
    if(this.ticket.id == null){
      ...
      if(this.ticket.status == 'INPROCESS'){
        this.msg = 'Ticket is in process can not be updated';
        alert(this.msg);
        this._router.navigate(['/tickets']);
        return;
      }
      this._service.updateTicketFromRemote(this.ticket, this.userId, this.ticket.id.toString()).subscribe(
        data =>{
          console.log(data);
